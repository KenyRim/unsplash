...
public class MapView extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap map) {
        ...
        moscow = new LatLng(55.753960, 37.620393);
        map.addMarker(new MarkerOptions().position(moscow)
                ...
                locationResult.addOnCompleteListener(this,task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (lastKnownLocation != null) {
                            ...
                            LatLng myLocation = new LatLng(lastKnownLocation.getLatitude(), lastKnownLocation.getLongitude());                            polyline = map.addPolyline(new PolylineOptions()
                                    .clickable(true)
                                    .add(
                                            myLocation,
                                            moscow));
